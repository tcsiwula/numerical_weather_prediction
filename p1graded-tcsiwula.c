/*
Program accepts required inputs     
Initial Guess 2 / 2
Error Tolerance 2 / 2
Max Iterations  2 / 2
      
Print required information      
Whether iterations converged  2 / 2
Number of iterations  2 / 2
approx solution 2 / 2
f(approx solution)  0 / 2
      
return val - approx solution  4 / 4
in args: x_0, err_tol, max_iters  4 / 4
out args: iter_count, whether iters converged 0 / 4
      
C function implementing f(x)  3 / 3
C function implementing f'(x) 3 / 3
